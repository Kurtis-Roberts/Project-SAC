        ...
        $.get("/api/families/" + familyID, function(data) {
            ...
            if (userRole === "Child") {
                ...
                for (i = 0; i < data.length; i++) {
                    ...
                    var button1 = $('<button type="button" class="btn btn-secondary change-points" data-toggle="modal" data-target="#cashOutModal" data-id=' + data[i].Fbid + '>Cash Out</button>')
                    ...
                    for (k = 0; k < data[i].Chores.length; k++) {
                        ...
                        if (data[i].Chores[k].status === "in progress") {
                            ...
                            var row = $("<div>")
                            row.addClass("row newChore card")
                            ...
                            var recjectButton = $('<button type="button" class="btn btn-secondary reject-button" data-chore=' + data[i].Chores[k].id + ' data-user=' + data[i].Fbid + '>Reject</button>')
                            col3.append(recjectButton)

                            var col4 = $("<div>")
                            col4.addClass("col-6 text-left")
                            var acceptButton = $('<button type="button" class="btn btn-secondary accept-button" data-chore=' + data[i].Chores[k].id + ' data-user=' + data[i].Fbid + ' data-points=' + data[i].Chores[k].chore_value + '>Accept</button>')
